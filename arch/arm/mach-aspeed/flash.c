...
#define AST_FMC_INT_CTRL_STAT   (AST_FMC_BASE + REG_FLASH_INTERRUPT_STATUS)
#define AST_FMC_DMA_CTRL        (AST_FMC_BASE + REG_FLASH_DMA_CONTROL)
#define AST_FMC_DMA_FLASH_ADDR  (AST_FMC_BASE + REG_FLASH_DMA_FLASH_BASE)
#define AST_FMC_DMA_DRAM_ADDR   (AST_FMC_BASE + REG_FLASH_DMA_DRAM_BASE)
#define AST_FMC_DMA_LENGTH      (AST_FMC_BASE + REG_FLASH_DMA_LENGTH)
