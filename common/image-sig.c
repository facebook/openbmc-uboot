 ...
 *
 * @fit: FIT to check
 * @noffset: Offset of configuration signature within configuation
 * 	(e.g. /configurations/conf-1/signature)
 * @sig_blob: control FDT contain the public key(s)
...
static int fit_config_check_sig(const void *fit, int noffset,
				const void *sig_blob, int required_keynode,
				int conf_noffset, char **err_msgp)
{
