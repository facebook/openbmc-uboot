...
/*-----------------------------------------------------------------------*/
//#define CONFIG_CMD_SF		//spi flash cmd
...
#define CONFIG_SPI
#define CONFIG_FMC_SPI
#define CONFIG_SPI_FLASH
//#define CONFIG_SPI_FLASH_ATMEL
#define CONFIG_SPI_FLASH_WINBOND
#define CONFIG_SPI_FLASH_MACRONIX
#define FOUR_BYTE_MODE
//#define CONFIG_SPI_FLASH_M25P80
...
#define CONFIG_ENV_SECT_SIZE			0x1000//(64 * 1024)		/*  x  = xM */
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	"verify=yes\0"	\
	"spi_dma=yes\0" \
	"update=tftp 40800000 ast2300.scr; so 40800000\0" \
	""
