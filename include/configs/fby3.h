...
#ifndef __FBY3_CONFIG_H
#define __FBY3_CONFIG_H

#define CONFIG_FBY3 1
...
#ifdef CONFIG_SPL
#define CONFIG_BOOTARGS          "debug console=ttyS0,57600n8 root=/dev/ram rw printk.time=1 dual_flash=2 coherent_pool=512K"
#else
