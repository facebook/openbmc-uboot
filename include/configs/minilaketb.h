...
#ifndef __MINILAKETB_CONFIG_H
#define __MINILAKETB_CONFIG_H

#define CONFIG_MINILAKETB 1
...
#ifdef CONFIG_SPL
#define CONFIG_BOOTARGS          "debug console=ttyS1,57600n8 root=/dev/ram rw printk.time=1 dual_flash=1"
#else
#define CONFIG_BOOTARGS          "debug console=ttyS1,57600n8 root=/dev/ram rw printk.time=1"
#endif
#define CONFIG_UPDATE            "tftp 80800000 ast2500.scr; so 80800000'"
#define CONFIG_BOOTFILE          "flash-minilaketb"
...
#define CONFIG_ASPEED_UART1_ENABLE
#define CONFIG_ASPEED_UART1_BMC
/*
