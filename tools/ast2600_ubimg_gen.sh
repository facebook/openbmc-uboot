...
print_usage() {
	echo "AST2600 UART booting Image Generator"
	echo ""
	echo "This script is used to generate a booting image with"
	echo "the AST2600 UART booting header pre-appended. This is"
	echo "mainly for recovery purpose"
	echo ""
